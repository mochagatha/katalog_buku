              ...
              <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                        <a href="index.php?include=detail-buku&data=<?= $id_buku ?>" 
    ...
    <section id="quotes-item" class="bg-light" style="min-height: 80px;padding:40px 0px 0px 0px;">
        <div class="container">
            <blockquote class="blockquote text-center">
                <p class="mb-0">entah di mana dirimu berada, bakso kont</p>
              ...
              ?>
                ...
                <div class="col-md-6">
                    <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        ...
                        <h3 class="mb-0"><a href="index.php?include=detail-blog&data=<?= $id_blog ?>"><?= $judul_blog; ?></a></h3>
