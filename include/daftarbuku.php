        ...
        <div class="row">
          <div class="col-md-9 katalog-detail">
            ...
            ?>
              ...
              <table class="table table-bordered">
                <tr>
                  <td width="40%" rowspan="6"><img src="admin/cover/<?= $cover; ?>" class="img-fluid" alt="Books Collection" title="Books"></td>
          ...
          <aside class="col-md-3 katalog-sidebar">
            ...
            <div class="pl-4 pb-4">
              ...
              ?>
                <li><a href="index.php?include=detail-buku&data=<?= $id_buku_terkait; ?>">
                <?= $judul_buku_terkait; ?></a></li>
              <?php } ?>
              </ol>
            </div>
