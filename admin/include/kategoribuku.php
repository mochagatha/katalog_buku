            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="index.php?include=tambah-kategori-buku" 
                  class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah  Kategori Buku</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  window.location.href = 'index.php?include=kategori-buku&aksi=hapus&data=<?php echo 
                    $id_kategori_buku;?>&notif=hapusberhasil'" 
                    class="btn btn-xs btn-warning"><i class="fas fa-trash"> Hapus</i>  
                </a>
                  </td>
              </tr>
              <?php $posisi++;}?>
