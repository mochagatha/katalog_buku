                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      if (!empty($katakunci_kategori)){
                        $sql_jum .= " WHERE `b`.`judul` LIKE '%$katakunci_kategori%' OR `k`.`kategori_buku` LIKE '%$katakunci_kategori%' OR `p`.`penerbit` LIKE '%$katakunci_kategori%'";
                      } 
                    ...
                    if(!isset($_GET['halaman'])){
                      ...
                      if (!empty($katakunci_kategori)){
                        $sql_b .= " WHERE `b`.`judul` LIKE '%$katakunci_kategori%' OR `k`.`kategori_buku` LIKE '%$katakunci_kategori%' OR `p`.`penerbit` LIKE '%$katakunci_kategori%'";
                        }
