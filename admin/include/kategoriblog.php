            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="index.php?include=tambah-kategori-blog" 
                  class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Kategori Blog</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  if(!isset($_GET['halaman'])){
                    ...
                    <tr>
                      ...
                      class="btn btn-xs btn-info"><i class="fas fa-edit">Edit</i></a>
              ...
              <ul class="pagination pagination-sm m-0 float-right">
                ...
                if($halaman!=1){
                  ...
                  href='index.php?include=kategori-blog&halaman=1'>
                  First</a></li>";
                  echo "<li class='page-item'><a class='page-link' 
                  href='index.php?include=kategori-blog&halaman=$sebelum'>
                  «</a></li>";
                }
                ...
                if($halaman!=$jum_halaman){
                    ...
                    <a class='page-link' 
                    href='index.php?include=kategori-blog&halaman=$setelah'>
                    »</a></li>";
                    echo "<li class='page-item'>
                    <a class='page-link' 
