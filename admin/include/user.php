        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td align="center">
                  <a href="index.php?include=edit-user&data=<?php echo $nama;?>" title="Edit" name="aksi" 
                  value="edit" class="btn btn-xs btn-info"><i class="fas fa-edit"></i></a>
                  <a href="index.php?include=detail-user&data=<?php echo $nama;?>" class="btn btn-xs btn-info" 
                  name="detail" value="detail" title="Detail"><i class="fas fa-eye"></i></a>
